...
export const translations: Record<Language, Translations> = {
  sr: {
    ...
    catTorbice: 'UNIKATNE TORBICE',
    catSubare: 'ŠUBARE',
    catCarape: 'VEZENE ČARAPE',
    catKosulje: 'VEZENE KOŠULJE',
    catNakit: 'HEKLANI NAKIT',
    catDom: 'UNIKATNI POKLONI',
    catDomPokloni: 'UNIKATNI POKLONI',
    priceTag: 'Cena:',
    priceRsd: 'RSD',
  ...
  en: {
    ...
    catTorbice: 'UNIQUE BAGS',
    catSubare: 'FUR HATS',
    catCarape: 'EMBROIDERED SOCKS',
    catKosulje: 'EMBROIDERED SHIRTS',
    catNakit: 'CROCHETED JEWELRY',
    catDom: 'UNIQUE GIFTS',
    catDomPokloni: 'UNIQUE GIFTS',
    priceTag: 'Price:',
    priceRsd: 'RSD',
